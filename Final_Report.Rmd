...
seasons_all_cat2 <- seasons_all_cat %>% 
  filter(n <= 12) %>% 
  nrow()

questions_per_category <- (seasons_all_cat_count/seasons_all_clean_count)*100
```
In 34 seasons (excluding 2019), 341,807 questions were asked and 43,369 different categories were used. On average, there were 12.68 questions per category, however, 1606 categories were only used once, and 39,863 categories were used less than 12 times.  

See these lists of categories here:
#####
Add these dataframes into the flexdashboard.
#####
...
# Did the top 5 most commonly used categories change after 1997?
```{r}
