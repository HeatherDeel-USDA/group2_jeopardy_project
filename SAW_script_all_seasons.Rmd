...
Our research question aims to ask which categories appear most often in the 35 seasons that Jeopardy has run and within a category, how often do some words appear. In this analysis, we will look at the top 5 most repeated categories. Next we ask how often "Athena" or "Zeus" appear in the question or answer and in which categories gods occur. 
...
top5_year_count_plot <- top5_year_count %>% 
  ...
  theme_classic() +
  ggtitle("Number of questions asked in top 5 categories by season") +
...
top5_year_count_plot <- top5_year_count %>% 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(y = "Number of questions asked")
